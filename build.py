...
def nav_html(base, current):
    ...
    for href, label in NAV:
        ...
        desk.append(f'<a href="{base}{href}"{cls} data-track="nav_click" data-label="{label}">{label}</a>')
        mob.append(f'<a href="{base}{href}"{cls} data-track="nav_click_mobile" data-label="{label}">{label}</a>')
    return "\n        ".join(desk), "\n      ".join(mob)
